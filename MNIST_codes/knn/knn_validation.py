...
# ------------------------------------------------------------------------------------
# HIPERPARAMETRO
# OBS: DIMINUI O VOLUME DO DATASET, E TESTAR PRA VER SE O HIERPARAMETRO IDEAL SE MANTEM O MESMO, SE SIM, DIMINUIR E FAZER TESTES PESADOS (COM MUITAS ITERASOES E CV E VARIOS PARAMETROS).
...
# TRAIN COM RUIDO
knn = KNeighborsClassifier()
random_search2 = RandomizedSearchCV(knn, param_distributions=param_dist, n_iter=100, cv=5, random_state=42)
...
# Melhor valor 
idealHyperparameter = random_search2.best_params_["n_neighbors"]
print("Melhor valor de k encontrado:", idealHyperparameter)
# Accuracy
print("Acurácia do modelo com o melhor k:", random_search2.best_score_ * 100, "%")
