...
tree_sem_ruido = DecisionTreeClassifier(max_depth=17, min_samples_leaf=4, random_state=42) # 16
...
tree_com_ruido = DecisionTreeClassifier(max_depth=17, min_samples_leaf=4, random_state=42)
