...
svm_sem_ruido = make_pipeline(LinearSVC(random_state=42, dual='auto', C=37.5540118, class_weight='balanced', tol=0.001))
svm_sem_ruido.fit(X, train_and_validation_labels)

# Train com ruido 
X = pixels_com_ruido_train_and_validation
X = X.reshape(X.shape[0], -1)
svm_com_ruido = make_pipeline(LinearSVC(random_state=42, dual='auto', C=37.5540118, class_weight='balanced', tol=0.001))
